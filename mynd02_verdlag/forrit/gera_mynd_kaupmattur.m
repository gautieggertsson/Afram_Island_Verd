...
yL = spjald(axL, L, GRAY, ...
    ...
    'Ísland næsthæst í samanburðinum', ...
...
function pila(fig, axL, axR, yL, yR, txt, RED, xstart, hlid)
    ...
    % Hnikað örlítið eftir örinni svo stærri textinn skyggi ekki á tölumerki.
    pos = (p1+p2)/2 + dv*0.035 + hlid*nh*0.055;
    text(ov, pos(1), pos(2), txt, 'Color',RED, 'FontSize',10.2, ...
